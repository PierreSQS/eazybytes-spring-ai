...
public class RandomDataLoader {
    ...
    public void loadSentencesIntoVectorStore() {
        ...
        // Convert each sentence into a Document object which the VectorStore expects.
        // map each String to a Document and collect into a List.
        List<Document> documents = sentences.stream()
                .map(Document::new)
                .toList();

        // Add all created documents to the configured VectorStore so they are indexed/stored.
